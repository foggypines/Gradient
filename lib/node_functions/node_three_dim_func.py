...
class ThreeDimNodeFunction(BaseNodeFunction, JSONWizard):
    ...
    def __post_init__(self):
        ...
        if self.x == None:
            ...
            self.x = self.add_input(node_x_input, ui_element=True, ui_label = 'x')

        if self.y == None:

            self.y = self.add_input(node_y_input, ui_element=True, ui_label = 'y')

        if self.z == None:

            self.z = self.add_input(node_z_input, ui_element=True, ui_label = 'z')
